...
var require_RAFManager_min = __commonJS({
  "../node_modules/raf-manager/build/RAFManager.min.js"(exports, module) {
    !(function(t, i) {
      ...
      return (function() {
      ...
      })(), { timer: 0, state: "stop", animations: [], paused: false, immediate: true, add: function(t) {
        ...
        return this.animations.push(n), this.immediate && this.animations.length >= 1 && this.start(), this;
      }, getIndex: function(t) {
        ...
        if (!(this.getIndex(t) < 0)) return this.deleteMap(t), this.immediate && 0 === this.animations.length && this.stop(), this;
        ...
        if ("start" === this.state && !this.paused) return this.paused = true, this;
      }, resume: function() {
        if ("start" === this.state && this.paused) return this.paused = false, this;
      }, tick: function() {
        var t = this;
        if (this.timer = requestAnimationFrame(function() {
          t.tick();
        }), !this.paused) for (var i = 0; i < this.animations.length; i++) {
  ...
  "../node_modules/proton-engine/build/proton.min.js"(exports, module) {
    !(function(t, e) {
      ...
      function n(t2, e2, i2) {
        ...
        if (null !== (t2 = Object.getPrototypeOf(t2))) return n(t2, e2, i2);
      }
      ...
      var c = function(t2) {
        --t2;
        for (var e2 = 1; e2 < 32; e2 <<= 1) t2 |= t2 >> e2;
        return t2 + 1;
      }, d = function(t2, e2) {
        ...
        for (i2 in t2) a2 && -1 < a2.indexOf(i2) || delete t2[i2];
        ...
        for (var i2 in e2) t2.hasOwnProperty(i2) && (t2[i2] = l.getSpanValue(e2[i2]));
        return t2;
        ...
        if ("function" == typeof Object.assign) return Object.assign(t2, e2);
        for (var i2 in e2) Object.prototype.hasOwnProperty.call(e2, i2) && (t2[i2] = e2[i2]);
        return t2;
        ...
        for (i2 in this._cache) {
          if ((e2 = this._cache[i2]) === t2) return i2;
          if (this.isBody(e2, t2) && e2.src === t2.src) return i2;
        }
        return null;
        ...
        var t2, e2 = 0;
        for (t2 in this.cache) e2 += this.cache[t2].length;
        return e2++;
      } }, { key: "destroy", value: function() {
        for (var t2 in this.cache) this.cache[t2].length = 0, delete this.cache[t2];
      ...
      var O = (t(w, [{ key: "update", value: function(t2, e2) {
        ...
        for (var i2 = 0; i2 < t2.length; i2++) e2 += (t2[i2].name || "").substr(0, 1) + ".";
        return e2;
      ...
      var C = (t(S, [{ key: "addEventListener", value: function(t2, e2) {
        ...
        if (this._listeners && this._listeners[t2]) {
          for (var i2 = this._listeners[t2], a2 = i2.length, r2 = 0; r2 < a2; r2++) if (i2[r2] === e2) {
        ...
        if (t2 && a2) {
          var r2 = a2[t2];
          if (!r2) return i2;
          for (var n2 = void 0, s2 = r2.length; s2--; ) n2 = r2[s2], i2 = i2 || n2(e2);
        }
        return !!i2;
      ...
      var V = (t(M, [{ key: "addRenderer", value: function(t2) {
        ...
        for (var e2 = this.emitters.length; e2--; ) this.emitters[e2].update(t2);
        ...
        for (var t2 = 0, e2 = this.emitters.length; e2--; ) t2 += this.emitters[e2].particles.length;
        return t2;
      } }, { key: "getAllParticles", value: function() {
        for (var t2 = [], e2 = this.emitters.length; e2--; ) t2 = t2.concat(this.emitters[e2].particles);
        return t2;
      ...
      var j = (t(N, [{ key: "getDirection", value: function() {
        ...
        for (var i2 = this.behaviours.length, a2 = void 0, a2 = 0; a2 < i2; a2++) this.behaviours[a2] && this.behaviours[a2].applyBehaviour(this, t2, e2);
        ...
        for (var e2 = t2.length, i2 = void 0, i2 = 0; i2 < e2; i2++) this.addBehaviour(t2[i2]);
      ...
      var X = { create: function(t2) {
        ...
        for (var i2 = 0; i2 < 9; i2++) e2[i2] = t2[i2];
        return e2;
      ...
      var gt = (t(mt, [{ key: "reset", value: function(t2, e2) {
        ...
        for (var t2 = this.parents.length; t2--; ) this.parents[t2].removeBehaviour(this);
      ...
      var Xt = { initialize: function(t2, e2, i2) {
        for (var a2 = i2.length, r2 = void 0, r2 = 0; r2 < a2; r2++) i2[r2] instanceof $ ? i2[r2].init(t2, e2) : this.init(t2, e2, i2[r2]);
        ...
        for (; 0.0167 < t2; ) t2 -= 0.0167, this.update(0.0167);
        this.stoped = e2, this.emitTime = i2 + Math.max(t2, 0), this.totalTime = a2;
      } }, { key: "removeAllParticles", value: function() {
        for (var t2 = this.particles.length; t2--; ) this.particles[t2].dead = true;
      } }, { key: "addSelfInitialize", value: function(t2) {
        t2.init ? t2.init(this) : this.initAll();
      } }, { key: "addInitialize", value: function() {
        for (var t2 = arguments.length, e2 = Array(t2), i2 = 0; i2 < t2; i2++) e2[i2] = arguments[i2];
        for (var a2 = e2.length; a2--; ) this.initializes.push(e2[a2]);
        ...
        if (this.parent) {
          ...
          for (var i2 = void 0, a2 = void 0, i2 = this.particles.length - 1; 0 <= i2; i2--) (a2 = this.particles[i2]).update(t2, i2), this.parent.integrator.calculate(a2, t2, e2), this.dispatch("PARTICLE_UPDATE", a2), a2.dead && (this.dispatch("PARTICLE_DEAD", a2), this.parent.pool.expire(a2), this.particles.splice(i2, 1));
        }
        ...
        if ("once" === this.totalTime) {
          ...
          for (0 < i2 && (this.emitSpeed = i2), e2 = 0; e2 < i2; e2++) this.createParticle();
          this.totalTime = "none";
        } else if (this.emitTime += t2, this.emitTime < this.totalTime) {
          var a2 = this.rate.getValue(t2), r2 = void 0;
          for (0 < a2 && (this.emitSpeed = a2), r2 = 0; r2 < a2; r2++) this.createParticle();
        }
      ...
      var Zt = (r(Qt, Yt), t(Qt, [{ key: "addSelfBehaviour", value: function() {
        ...
        if (n(Qt.prototype.__proto__ || Object.getPrototypeOf(Qt.prototype), "update", this).call(this, t2), !this.sleep) for (var e2 = this.selfBehaviours.length, i2 = void 0, i2 = 0; i2 < e2; i2++) this.selfBehaviours[i2].applyBehaviour(this, t2, i2);
      } }]), Qt);
      function Qt(t2) {
        o(this, Qt);
      ...
      function ye() {
        o(this, ye), this.mats = [];
        for (var t2 = this.size = 0; t2 < 20; t2++) this.mats.push(X.create([0, 0, 0, 0, 0, 0, 0, 0, 0]));
      }
      r(pe, $t), t(pe, [{ key: "init", value: function(t2) {
        ...
        for (var e2 = void 0, i2 = [], e2 = 0; e2 < 100; e2++) i2.push(e2);
        for (t2 = new Uint16Array(i2), this.unitI33 = this.gl.createBuffer(), this.gl.bindBuffer(this.gl.ELEMENT_ARRAY_BUFFER, this.unitI33), this.gl.bufferData(this.gl.ELEMENT_ARRAY_BUFFER, t2, this.gl.STATIC_DRAW), i2 = [], e2 = 0; e2 < 100; e2++) i2.push(e2, e2 + 1, e2 + 2);
      ...
      var ve = (r(ge, at), t(ge, [{ key: "getPosition", value: function() {
        ...
        if (Math.abs(this.getGradient()) <= s.PI / 4) {
          if (t2.p.x <= this.maxx && t2.p.x >= this.minx) return true;
        } else if (t2.p.y <= this.maxy && t2.p.y >= this.miny) return true;
        return false;
      ...
      r(ke, at), t(ke, [{ key: "reset", value: function(t2, e2, i2, a2) {
        ...
        for (var t2 = void 0, e2 = void 0, i2 = this.imageData.width, a2 = this.imageData.height, t2 = 0; t2 < i2; t2 += this.d) for (e2 = 0; e2 < a2; e2 += this.d) {
...
var Color$1 = (function(_React$Component) {
  ...
  createClass(Color2, [{
    ...
    value: function createProton(canvas, width, height) {
      ...
      if (body) emitter.addInitialize(new import_proton_engine.default.Body(body));
      var pos = void 0;
